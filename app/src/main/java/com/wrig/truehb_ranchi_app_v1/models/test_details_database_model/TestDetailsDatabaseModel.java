package com.wrig.truehb_ranchi_app_v1.models.test_details_database_model;
...
public class TestDetailsDatabaseModel implements Serializable {
    ...
    public TestDetailsDatabaseModel() {
    }

    public TestDetailsDatabaseModel(int id, String test_id, int u_id, String client_name, int client_age, int client_gender, int client_pregnant_status, String client_hb_value, String district, String block, String phc_uhc_sc, String test_time_stamp, int server_status) {
        this.id = id;
